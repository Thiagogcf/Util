...
final = datetime(datetime.now().year, datetime.now().month, datetime.now().day, 17, 27, 0).timestamp()
final2 = datetime(datetime.now().year, datetime.now().month, datetime.now().day, 11, 57, 5).timestamp()
