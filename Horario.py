...
inicioexpediente = datetime(datetime.now().year, datetime.now().month, datetime.now().day, 7, 52,30).timestamp()
...
final2 = datetime(datetime.now().year, datetime.now().month, datetime.now().day, 11, 59, 5).timestamp()
