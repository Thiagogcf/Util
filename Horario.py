...
inicioexpediente = datetime(datetime.now().year, datetime.now().month, datetime.now().day, 8, 8,30).timestamp()
iniciotarde = datetime(datetime.now().year, datetime.now().month, datetime.now().day, 13, 0,00).timestamp()
iniciohora = datetime.now().time()
final = datetime(datetime.now().year, datetime.now().month, datetime.now().day, 16, 0, 59).timestamp()
